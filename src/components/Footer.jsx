    ...
    <footer
      style={{
        background: darkMode
          ...
          : "linear-linear(to bootom, #f3f4f6, #e5e7eb)",
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="flex gap-4">
            ...
            <a
              href="https://www.linkedin.com/in/rohit-pandey-9055b9323/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full flex items-center
                    justify-center hover:scale-110 transition-all
                    hover:bg-linear-to-r hover:from-prange-500
                    hover:to-amber-500 hover:text-white
                    bg-[#374151] dark:bg-[#f3f4f6]
                    text-white dark:text-[#374151]"
            >
          ...
          <div className="text-center md:text-right">
            ...
            >
              ...
              by <span className="mt-1 text-[#f97316]">Rohit Pandey</span>
            </p>
          </div>
        </div>
      </div>
